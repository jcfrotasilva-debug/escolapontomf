...
export async function POST(request: Request) {
  try {
    ...
    const validTypes = ['vacation', 'medical_leave', 'maternity_leave', 'paternity_leave', 'bereavement_leave', 'marriage_leave', 'technical_orientation', 'school_recess', 'bank_withdrawal', 'other'];
